...
})(
  {
                ...
                var _this = this,
                  select = function select(dir) {
                    if (_this._selection) {
                      ...
                      _this._selection =
                        _this._selection[
                          dir > 0 ? 'nextSibling' : 'previousSibling'
                        ];
                    }
                    if (!_this._selection) {
                      _this._selection =
        ...
        (function(global) {
          ...
          module.exports = {
            class: L.Class.extend({
              options: {
                serviceUrl:
                  'https://api.tiles.mapbox.com/v4/geocode/mapbox.places-v1/'
              },
                ...
                Util.jsonp(
                  ...
                  function(data) {
                    ...
                    if (data.results && data.results[0].locations) {
                      for (
                        var i = data.results[0].locations.length - 1;
                        i >= 0;
                        i--
                      ) {
          ...
          module.exports = {
            class: L.Class.extend({
              ...
              _deocodeFeatureName: function(f) {
                ...
                for (
                  j = 0;
                  !name && j < this.options.nameProperties.length;
                  j++
                ) {
        ...
        (function(global) {
          ...
          module.exports = {
            class: L.Class.extend({
              ...
              reverse: function(location, scale, cb, context) {
                Util.getJSON(
                  this.options.serviceUrl + 'position',
                  {
                    key: this._accessToken,
    ...
    9: [
      ...
      },
      {
        ...
        './geocoders/google': 3,
        './geocoders/mapbox': 4,
        './geocoders/mapquest': 5,
        './geocoders/nominatim': 6,
        './geocoders/photon': 7,
        './geocoders/what3words': 8
      }
    ],
    10: [
      function(require, module, exports) {
